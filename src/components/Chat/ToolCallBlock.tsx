...
function ToolSvgIcon({ type }: { type: string }) {
  switch (type) {
    case 'read':
      return (
        <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="var(--info)" strokeWidth="1.2">
    ...
    case 'write':
      return (
        <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="var(--warning)" strokeWidth="1.2">
    ...
    case 'exec':
      return (
        <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="var(--success)" strokeWidth="1.2">
    ...
    case 'search':
      return (
        <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="var(--accent)" strokeWidth="1.2">
